            <div class="htc__header__top">
                <div class="container">
                    <div class="row ">
                        <div class="col-lg-6 col-md-8 col-12 res-col">
                            <div class="ht__header__top__left">
                                ...
                                <p></span> شماره تماس: <a href="tel:02187700000">۸۷۷۰۰۰۰۰-۰۲۱</a><span><i class="zmdi zmdi-phone"></i></p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-4 col-12 res-col-top">
                            <div class="ht__header__top__right">
                                <p class=""><storng style="font-size: 16px;">کلینیک تخصصی پوست و مو و زیبایی - مدرن </storng><br> همه روزه ۸:۰۰ صبح الی ۹:۰۰ شب <span><i class="zmdi zmdi-alarm-check"></i></span></p>
                            </div>
                        </div>
                    </div>
                </div>
